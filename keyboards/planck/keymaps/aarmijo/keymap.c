...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	*/
	...
	[_NUMBERS] = LAYOUT_planck_grid(
		...
		KC_TRNS, QWERTY,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P0, KC_PCMM, KC_PDOT, KC_PPLS, KC_PEQL
	),
	...
	[_LOWER] = LAYOUT_planck_grid(
		...
		KC_TRNS, NUMBERS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RAISE,   KC_RALT,    KC_RGUI,  KC_APP,  KC_RCTL
	), 
	...
	[_RAISE] = LAYOUT_planck_grid(
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_RALT, KC_RGUI, KC_APP,  KC_RCTL
	),
