...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL,           FUNCTION, KC_LGUI, KC_LALT, TT(_LOWER), KC_SPC, KC_SPC, TT(_RAISE), RALT_T(KC_LEFT), RGUI_T(KC_DOWN), TD(TD_UP_APP), RCTL_T(KC_RGHT)
  ),
  ...
  */
  ...
  [_LOWER] = LAYOUT_planck_grid(
    ...
    KC_TRNS, KC_MPRV, KC_VOLD, KC_MPLY, KC_VOLU, KC_MNXT, RALT(KC_N), KC_MUTE, S(KC_NUBS), KC_TRNS,  KC_HOME, KC_END,
    KC_TRNS, NUMBER,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS, KC_MPRV,    KC_VOLD,  KC_VOLU, KC_MPLY
  ), 
  ...
  [_NUMBER] = LAYOUT_planck_grid(
    DEFAULT, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_P7, KC_P8,   KC_P9,   KC_0,    KC_DEL,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P4, KC_P5,   KC_P6,   KC_PAST, KC_PSLS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P1, KC_P2,   KC_P3,   KC_PMNS, KC_PEQL,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PPLS, KC_PPLS, KC_P0, KC_PDOT, KC_TRNS, KC_TRNS, KC_TRNS
  ),

  /* Adjust (Lower + Raise) */
  [_ADJUST] = LAYOUT_planck_grid(
    KC_TRNS, QK_BOOT, DB_TOGG, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD,  RGB_VAI, RGB_VAD, EE_CLR,
    KC_TRNS, KC_TRNS, MU_NEXT, AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK,  DVORAK,  PLOVER,  KC_TRNS,
  ...
  [_FUNCTION] = LAYOUT_planck_grid(
    ...
    KC_TRNS, RUT,     EMAIL,   PHONE,   CC,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
