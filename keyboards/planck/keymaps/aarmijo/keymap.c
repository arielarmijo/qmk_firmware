...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  ...
  [_LOWER] = LAYOUT_planck_grid(
    ...
    KC_TRNS, NUMBERS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS, KC_MPRV,    KC_VOLD,  KC_VOLU, KC_MPLY
  ), 
  ...
  [_FUNCTION] = LAYOUT_planck_grid(
    ...
    KC_TRNS, RUT,     EMAIL,   PHONE,   CC,      BD,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
